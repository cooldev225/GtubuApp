            ...
            <div class="header-container  3">                    
                ...
                <div class="page-heading listing-page" style=" ">
					<div class="page-heading-inner-container text-center">
						<h1>Dashboard</h1>
						<ul class="breadcrumbs"><li><a href="/">Home</a></li> <li><span>Dashboard</span></li></ul>					</div>
            ...
            <div id="wrapper" class="active lp-dashboard-new clearfix lp-dashboard-new-active">		 
                <div id="sidebar-wrapper">
				    ...
				    <ul class="sidebar-nav clearfix" id="sidebar"> 
                        <li>
                            <a  href="http://localhost/listing-author/?dashboard=main-screen"><span class="sub_icon sub_iconfirst"> <i class="fa fa-dashboard"></i> </span> Dashboard <span class="sub_icon sub_iconsecond simptip-position-right simptip-movable" data-tooltip="Dashboard"><i class="fa fa-dashboard"></i></span></a>
                        </li>
                        <li>
                            <a class="active-dash-menu" href="http://localhost/listing-author/?dashboard=announcements"><span class="sub_icon sub_iconfirst"><i class="fa fa-microphone" aria-hidden="true"></i></span> Announcements <span class="sub_icon sub_iconsecond simptip-position-right simptip-movable" data-tooltip="Announcements"> <i class="fa fa-microphone" aria-hidden="true"></i></span></a> 
                        </li>							
                        <li>
                            <a  href="http://localhost/listing-author/?dashboard=events">
                                <span class="sub_icon sub_iconfirst"><i class="fa fa-calendar" aria-hidden="true"></i></span> Events <span class="sub_icon sub_iconsecond simptip-position-right simptip-movable" data-tooltip="Events"> <i class="fa fa-calendar" aria-hidden="true"></i></span>								   
                            </a>
                        </li>
                    </ul>
                </div>			  			
                                    ...
                                    <ul class="clearfix">
                                        ...
                                        <li>
                                            <div class="user-meta-image ">
                                                <a href=""><img src="http://1.gravatar.com/avatar/71dc3ffe3416a9f7cfbc17ae40e4ed5a?s=94&#038;d=mm&#038;r=g" alt="avatar" /></a>
                                            </div>									
								        </li>
                                        <li>
                                            <div class="lp-user-header-details lp-dot-extra-buttons">
                                                ...
                                                <ul class="lp-user-menu list-style-none">
                                                    <li>
                                                        <a href="http://localhost/listing-author/?dashboard=update-profile"> <i class="fa fa-user-circle"></i> Mi Perfil </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://localhost/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Flocalhost%2F&amp;_wpnonce=de2d2b5690">
...
( 'fetch' in window ) || document.write( '<script src="/frontend/js/wp-polyfill-fetch.min.js"></scr' + 'ipt>' );( document.contains ) || document.write( '<script src="http://localhost/wp-includes/js/dist/vendor/wp-polyfill-node-contains.min.js"></scr' + 'ipt>' );( window.DOMRect ) || document.write( '<script src="http://localhost/wp-includes/js/dist/vendor/wp-polyfill-dom-rect.min.js"></scr' + 'ipt>' );( window.URL && window.URL.prototype && window.URLSearchParams ) || document.write( '<script src="http://localhost/wp-includes/js/dist/vendor/wp-polyfill-url.min.js"></scr' + 'ipt>' );( window.FormData && window.FormData.prototype.keys ) || document.write( '<script src="http://localhost/wp-includes/js/dist/vendor/wp-polyfill-formdata.min.js"></scr' + 'ipt>' );( Element.prototype.matches && Element.prototype.closest ) || document.write( '<script src="http://localhost/wp-includes/js/dist/vendor/wp-polyfill-element-closest.min.js"></scr' + 'ipt>' );
</script>
