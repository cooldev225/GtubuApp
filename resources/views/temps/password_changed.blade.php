        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
              <!-- <h1 style="margin: 0; font-size: 22px; font-weight: 400; letter-spacing: -1px; line-height: 28px;">Brokerlive account</h1> -->
              <h1 style="margin: 0; font-size: 22px; font-weight: 700; letter-spacing: -1px; line-height: 38px;">Your password has been reset</h1>
            </td>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <h3>Hi, {{$userName}}</h3>
              <p style="margin: 0;">
                Vá em frente e faça login em sua conta agora.<br/><br/>
                Sua senha atual é <b>{{$content}}</b></p><br/><br/>
                Tem perguntas?<br/>
                Envie-nos um e-mail para
              <a href="mailto:{{$fromEmail}}" rel="noreferrer" style="text-decoration:none;pointer-events:none;cursor:default;" target="_blank" class="kix-link"><span class="kix-wordhtmlgenerator-word-node" style="font-size:16px;font-family:Arial;color:#1155cc;background-color:transparent;font-weight:400;font-style:normal;font-variant:normal;text-decoration:none;vertical-align:baseline;white-space:pre;">{{$fromEmail}}</span></a></p>
            </td>
          </tr>
          ...
          <!-- <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">
              If you did NOT make this change, please sign in, change your password and <font style="color: #1a82e2;font-size: 14pt;"> contact us</font>.</p>
            </td>
          </tr> -->
          <!-- <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
